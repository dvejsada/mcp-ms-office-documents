...
async def create_powerpoint_presentation(
    slides: Annotated[Slides, Field(
        description=(
            ...
            "deck's own section slides), divide with 'section', and end with 'closing'. Use 'kpi' for "
            "two to four headline figures and 'timeline' for three to five sequential steps.\n"
            "\n"
